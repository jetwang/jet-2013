...
public class Jetty {
    ...
    public static void main(String[] args) throws Exception {
        ...
        factory.setKeyStorePath("restapp/test-util/src/main/resources/keystore.jks");
        ...
        context.setResourceBase("restapp/web/src/main/webapp");

...
public class DataAccess {
    ...
    public <T> List<T> findByCriteria(final jetwang.framework.db.Criteria<T> criteria) {
    ...
    public <T> T findFirstResultByCriteria(final jetwang.framework.db.Criteria<T> criteria) {
    ...
    public <T> T loadByUniqueProperty(String propertyName, Object value, Class<T> clazz) {
        jetwang.framework.db.Criteria criteria = jetwang.framework.db.Criteria.of(clazz);
    ...
    public <T> List<T> findAll(final Class<T> cls, final Page page) {
        return findByCriteria(new jetwang.framework.db.Criteria<T>(cls), page);
    }
    ...
    @SuppressWarnings("unchecked")
    public <T> List<T> findByCriteria(final jetwang.framework.db.Criteria<T> criteria, final Page page) {
        return (List<T>) hibernateTemplate.executeWithNativeSession(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException {
                if (page.hasOrder()) {
